        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-in-left">
            ...
            <p className="text-lg leading-relaxed">
              Since our inception in {new Date().getFullYear() - 5}, we've grown into a trusted community, continuously evolving our features to meet the diverse needs of students, professionals, and travelers seeking their ideal living arrangements.
            </p>
          </div>
